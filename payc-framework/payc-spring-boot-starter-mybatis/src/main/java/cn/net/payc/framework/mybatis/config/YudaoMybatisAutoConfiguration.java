package cn.net.payc.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.net.payc.framework.common.util.json.JsonUtils;
import cn.net.payc.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${payc.info.base-package}", annotationClass = Mapper.class,
