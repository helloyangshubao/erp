package cn.net.payc.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${payc.websocket.sender-rocketmq.topic}",
        consumerGroup = "${payc.websocket.sender-rocketmq.consumer-group}",
