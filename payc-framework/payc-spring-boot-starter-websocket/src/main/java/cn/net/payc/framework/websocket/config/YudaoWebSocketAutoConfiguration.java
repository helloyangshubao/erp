package cn.net.payc.framework.websocket.config;

import cn.net.payc.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import cn.net.payc.framework.mq.redis.core.RedisMQTemplate;
import cn.net.payc.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.net.payc.framework.websocket.core.listener.WebSocketMessageListener;
import cn.net.payc.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.net.payc.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.net.payc.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.net.payc.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.net.payc.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.net.payc.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.net.payc.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.net.payc.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.net.payc.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.net.payc.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.net.payc.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.net.payc.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.net.payc.framework.websocket.core.session.WebSocketSessionManager;
import cn.net.payc.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
@ConditionalOnProperty(prefix = "payc.websocket", value = "enable", matchIfMissing = true) // 允许使用 payc.websocket.enable=false 禁用 websocket
...
public class YudaoWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "payc.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "payc.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "payc.websocket", name = "sender-type", havingValue = "rocketmq")
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${payc.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "payc.websocket", name = "sender-type", havingValue = "rabbitmq")
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${payc.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "payc.websocket", name = "sender-type", havingValue = "kafka")
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${payc.websocket.sender-kafka.topic}") String topic) {
