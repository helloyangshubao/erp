package cn.net.payc.framework.web.config;
...
import cn.net.payc.framework.web.core.filter.CacheRequestBodyFilter;
import cn.net.payc.framework.web.core.filter.DemoFilter;
import cn.net.payc.framework.web.core.handler.GlobalExceptionHandler;
import cn.net.payc.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YudaoWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "payc.demo", havingValue = "true")
