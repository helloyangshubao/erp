package cn.net.payc.framework.desensitize.core;

import cn.net.payc.framework.common.util.json.JsonUtils;
import cn.net.payc.framework.desensitize.core.annotation.Address;
import cn.net.payc.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.net.payc.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.net.payc.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("平安云厨科技集团");
        ...
        desensitizeDemo.setRegex("你好，我是平安云厨科技集团");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("平安云厨科技集团");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("平*******", d.getNickname());
        ...
        assertEquals("平安云厨科技集团", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "平安云厨科技集团", replacer = "*")
