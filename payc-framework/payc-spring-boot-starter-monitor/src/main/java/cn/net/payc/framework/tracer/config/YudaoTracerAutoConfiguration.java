package cn.net.payc.framework.tracer.config;

import cn.net.payc.framework.common.enums.WebFilterOrderEnum;
import cn.net.payc.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "payc.tracer", value = "enable", matchIfMissing = true)
