package cn.net.payc.module.erp.controller.admin.purchase.vo.supplier;
...
import cn.net.payc.module.system.enums.DictTypeConstants;
...
public class ErpSupplierRespVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "平安云厨科技集团")
    @ExcelProperty("供应商名称")
    private String name;
