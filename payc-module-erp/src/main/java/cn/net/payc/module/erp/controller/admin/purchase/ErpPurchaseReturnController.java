package cn.net.payc.module.erp.controller.admin.purchase;
...
import cn.net.payc.framework.common.util.collection.MapUtils;
import cn.net.payc.framework.common.util.object.BeanUtils;
import cn.net.payc.framework.excel.core.util.ExcelUtils;
import cn.net.payc.module.erp.controller.admin.product.vo.product.ErpProductRespVO;
import cn.net.payc.module.erp.controller.admin.purchase.vo.returns.ErpPurchaseReturnPageReqVO;
import cn.net.payc.module.erp.controller.admin.purchase.vo.returns.ErpPurchaseReturnRespVO;
import cn.net.payc.module.erp.controller.admin.purchase.vo.returns.ErpPurchaseReturnSaveReqVO;
import cn.net.payc.module.erp.dal.dataobject.purchase.ErpPurchaseReturnDO;
import cn.net.payc.module.erp.dal.dataobject.purchase.ErpPurchaseReturnItemDO;
import cn.net.payc.module.erp.dal.dataobject.purchase.ErpSupplierDO;
import cn.net.payc.module.erp.dal.dataobject.stock.ErpStockDO;
import cn.net.payc.module.erp.service.product.ErpProductService;
import cn.net.payc.module.erp.service.purchase.ErpPurchaseReturnService;
import cn.net.payc.module.erp.service.purchase.ErpSupplierService;
import cn.net.payc.module.erp.service.stock.ErpStockService;
import cn.net.payc.module.system.api.user.AdminUserApi;
import cn.net.payc.module.system.api.user.dto.AdminUserRespDTO;
...
import static cn.net.payc.framework.apilog.core.enums.OperateTypeEnum.EXPORT;
import static cn.net.payc.framework.common.pojo.CommonResult.success;
import static cn.net.payc.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.net.payc.framework.common.util.collection.CollectionUtils.convertSet;
