package cn.net.payc.module.system.service.tenant;

import cn.net.payc.framework.common.enums.CommonStatusEnum;
import cn.net.payc.framework.common.pojo.PageResult;
import cn.net.payc.framework.tenant.config.TenantProperties;
import cn.net.payc.framework.tenant.core.context.TenantContextHolder;
import cn.net.payc.framework.test.core.ut.BaseDbUnitTest;
import cn.net.payc.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.net.payc.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.net.payc.module.system.dal.dataobject.permission.MenuDO;
import cn.net.payc.module.system.dal.dataobject.permission.RoleDO;
import cn.net.payc.module.system.dal.dataobject.tenant.TenantDO;
import cn.net.payc.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.net.payc.module.system.dal.mysql.tenant.TenantMapper;
import cn.net.payc.module.system.enums.permission.RoleCodeEnum;
import cn.net.payc.module.system.enums.permission.RoleTypeEnum;
import cn.net.payc.module.system.service.permission.MenuService;
...
import cn.net.payc.module.system.service.tenant.handler.TenantInfoHandler;
import cn.net.payc.module.system.service.tenant.handler.TenantMenuHandler;
import cn.net.payc.module.system.service.user.AdminUserService;
...
import static cn.net.payc.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("云厨", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("云厨"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("云厨");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
