package cn.net.payc.module.system.service.mail;
...
import cn.net.payc.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.net.payc.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.net.payc.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.net.payc.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.net.payc.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("云厨")));
        // 测试 code 不匹配
