package cn.net.payc.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.net.payc.framework.common.enums.CommonStatusEnum;
import cn.net.payc.framework.common.exception.ServiceException;
import cn.net.payc.framework.common.pojo.PageResult;
import cn.net.payc.framework.common.util.collection.ArrayUtils;
import cn.net.payc.framework.common.util.collection.CollectionUtils;
import cn.net.payc.framework.test.core.ut.BaseDbUnitTest;
import cn.net.payc.module.infra.api.config.ConfigApi;
import cn.net.payc.module.infra.api.file.FileApi;
import cn.net.payc.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.net.payc.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.net.payc.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.net.payc.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.net.payc.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.net.payc.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.net.payc.module.system.dal.dataobject.dept.DeptDO;
import cn.net.payc.module.system.dal.dataobject.dept.PostDO;
import cn.net.payc.module.system.dal.dataobject.dept.UserPostDO;
import cn.net.payc.module.system.dal.dataobject.tenant.TenantDO;
import cn.net.payc.module.system.dal.dataobject.user.AdminUserDO;
import cn.net.payc.module.system.dal.mysql.dept.UserPostMapper;
import cn.net.payc.module.system.dal.mysql.user.AdminUserMapper;
import cn.net.payc.module.system.enums.common.SexEnum;
import cn.net.payc.module.system.service.dept.DeptService;
import cn.net.payc.module.system.service.dept.PostService;
import cn.net.payc.module.system.service.oauth2.OAuth2TokenService;
import cn.net.payc.module.system.service.permission.PermissionService;
import cn.net.payc.module.system.service.tenant.TenantService;
...
import static cn.net.payc.framework.common.util.collection.SetUtils.asSet;
import static cn.net.payc.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.net.payc.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.net.payc.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.net.payc.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.net.payc.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.net.payc.framework.test.core.util.RandomUtils.*;
import static cn.net.payc.module.system.enums.ErrorCodeConstants.*;
import static cn.net.payc.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
