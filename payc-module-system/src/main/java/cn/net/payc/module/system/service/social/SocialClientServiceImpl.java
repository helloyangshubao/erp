package cn.net.payc.module.system.service.social;
...
import cn.net.payc.framework.common.util.cache.CacheUtils;
import cn.net.payc.framework.common.util.http.HttpUtils;
import cn.net.payc.framework.common.util.object.BeanUtils;
import cn.net.payc.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.net.payc.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.net.payc.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.net.payc.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.net.payc.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.net.payc.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.net.payc.module.system.dal.dataobject.social.SocialClientDO;
import cn.net.payc.module.system.dal.mysql.social.SocialClientMapper;
import cn.net.payc.module.system.dal.redis.RedisKeyConstants;
import cn.net.payc.module.system.enums.social.SocialTypeEnum;
import cn.net.payc.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.net.payc.framework.common.util.collection.MapUtils.findAndThen;
import static cn.net.payc.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.net.payc.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.net.payc.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${payc.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${payc.wxa-subscribe-message.miniprogram-state:formal}")
