package cn.net.payc.module.infra.service.file;
...
import cn.net.payc.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import cn.net.payc.module.infra.dal.mysql.file.FileConfigMapper;
import cn.net.payc.module.infra.framework.file.core.client.FileClient;
import cn.net.payc.module.infra.framework.file.core.client.FileClientConfig;
import cn.net.payc.module.infra.framework.file.core.client.FileClientFactory;
import cn.net.payc.module.infra.framework.file.core.client.local.LocalFileClient;
import cn.net.payc.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import cn.net.payc.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static cn.net.payc.framework.test.core.util.RandomUtils.randomLongId;
import static cn.net.payc.framework.test.core.util.RandomUtils.randomPojo;
import static cn.net.payc.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.net.payc.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("平安云厨科技集团")
