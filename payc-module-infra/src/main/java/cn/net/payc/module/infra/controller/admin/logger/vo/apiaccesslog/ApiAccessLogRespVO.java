package cn.net.payc.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import cn.net.payc.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "平安云厨科技集团，牛逼！")
    @ExcelProperty("结果提示")
