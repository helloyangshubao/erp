package cn.net.payc.module.infra.service.codegen.inner;
...
import cn.net.payc.framework.apilog.core.annotation.ApiAccessLog;
import cn.net.payc.framework.apilog.core.enums.OperateTypeEnum;
...
import cn.net.payc.framework.common.pojo.PageParam;
...
import cn.net.payc.framework.common.util.date.LocalDateTimeUtils;
import cn.net.payc.framework.common.util.object.BeanUtils;
import cn.net.payc.framework.common.util.object.ObjectUtils;
import cn.net.payc.framework.common.util.string.StrUtils;
import cn.net.payc.framework.excel.core.annotations.DictFormat;
import cn.net.payc.framework.excel.core.convert.DictConvert;
import cn.net.payc.framework.excel.core.util.ExcelUtils;
import cn.net.payc.framework.mybatis.core.dataobject.BaseDO;
...
import cn.net.payc.module.infra.enums.codegen.CodegenVOTypeEnum;
...
public class CodegenEngine {
     ...
     *
     * true  - 需要有 payc-module-xxx-api 模块
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("cn.net.payc.module.infra.framework.rpc.config.RpcConfiguration",
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/payc-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/payc-module-${table.moduleName}-server", "");
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "payc-module-${table.moduleName}/" + // 顶级模块
                "payc-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "payc-module-${table.moduleName}/" + // 顶级模块
                "payc-module-${table.moduleName}-server/" + // 子模块
